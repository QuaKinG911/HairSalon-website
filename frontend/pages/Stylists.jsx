    ...
    return (<div className="bg-gray-900 min-h-screen py-16 px-4">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-12">
          {stylists.map((stylist) => (<div key={stylist.id} className="group cursor-pointer bg-gray-800 rounded-sm overflow-hidden shadow-lg flex flex-col h-full hover:shadow-xl transition-all duration-300">
              <div className="relative h-[400px] shrink-0 overflow-hidden">
                <img src={stylist.image} alt={stylist.name} className="w-full h-full object-cover object-center transition-all duration-500 group-hover:scale-105"/>
              ...
              <div className="p-6 flex flex-col flex-1 text-center">
                ...
                {stylist.schedule && (<div className="w-full bg-gray-900/50 p-4 rounded-lg border border-gray-700 mb-4 text-left">
                    ...
                    return daysOfWeek.map((day) => {
                        ...
                        return (<div key={day} className="flex justify-between">
                ...
                <div className="flex flex-wrap justify-center gap-2 mb-6">
                  {stylist.specialties.map((tech, idx) => (<span key={idx} className="text-[10px] text-gray-400 bg-gray-700 px-2 py-1 rounded-full border border-gray-600">
                      {tech}
                    </span>))}
                </div>

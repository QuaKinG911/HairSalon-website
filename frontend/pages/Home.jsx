    ...
    return (<div className="space-y-0">
      ...
      <section className="relative h-[85vh] flex items-center justify-center overflow-hidden bg-gray-900">
        <div className="absolute inset-0 z-0">
          <img src="/images/services/TheGentlemanPackage.jpg" alt="Barber Shop Interior" className="w-full h-full object-cover filter brightness-[0.4] saturate-0"/>
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8">
            <Link to="/booking" className="px-10 py-4 bg-amber-600 text-black rounded-sm font-bold uppercase tracking-wider hover:bg-amber-500 transition-all transform hover:-translate-y-1 shadow-lg shadow-amber-900/20">
              Book Appointment
            </Link>
            <Link to="/ai-try-on" className="px-10 py-4 bg-transparent text-white border border-white/20 rounded-sm font-bold uppercase tracking-wider hover:bg-white/10 transition-all flex items-center justify-center gap-2">
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="flex flex-col md:flex-row items-center gap-16">
            <div className="md:w-1/2 relative">
              ...
              <img src="/images/services/TheExecutiveCut.jpg" alt="The Executive Cut" className="relative rounded-sm shadow-2xl w-full h-[500px] object-cover grayscale hover:grayscale-0 transition-all duration-700"/>
            </div>
            <div className="md:w-1/2 space-y-8">
              ...
              <Link to="/services" className="inline-flex items-center gap-2 text-amber-500 font-bold hover:text-amber-400 transition-colors uppercase tracking-wide text-sm">

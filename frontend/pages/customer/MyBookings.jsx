...
const MyBookings = () => {
    ...
    const copyBookingNumber = (number) => {
                ...
                <div className="bg-gray-800 rounded-lg shadow-lg overflow-hidden">
                    ...
                    <div className="p-8">
                        {isLoading ? (<div className="flex justify-center items-center py-12">
                            ...
                            </div>) : bookings.length === 0 ? (<div className="text-center py-12">
                                <Calendar className="mx-auto text-gray-300 mb-4" size={64}/>
                                <h3 className="text-xl font-bold text-white mb-2">No Bookings Yet</h3>
                                <p className="text-gray-400 mb-6">You haven't made any appointments yet.</p>
                                <button onClick={() => navigate('/services')} className="px-6 py-3 bg-amber-600 text-white rounded-sm font-bold hover:bg-amber-500 transition-colors">
                                    Browse Services
                                </button>
                            </div>) : (<div className="space-y-4">
                                {bookings.map((booking) => (<div key={booking.id} className="bg-gray-800 border border-gray-700 rounded-lg p-6 hover:shadow-md transition-shadow">
                                        <div className="flex justify-between items-start mb-4">
                                            <div>
                                                <div className="flex items-center gap-3 mb-2">
                                                    ...
                                                    <button onClick={() => copyBookingNumber(booking.bookingNumber)} className="p-1 hover:bg-gray-700 rounded transition-colors" title="Copy booking number">
                                            ...
                                            <div className="flex items-start gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="font-medium text-white">
                                                        ...
                                                        {booking.paymentStatus === 'paid' && (<span className="ml-2 text-green-600 text-xs">✓ Paid</span>)}
                                                    </p>
                                                </div>
                                            </div>
                                        ...
                                        {booking.status === 'pending' && (<div className="mt-4 flex justify-between items-center bg-amber-50 border border-amber-200 rounded p-3 text-sm text-amber-800">
